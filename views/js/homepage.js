...
document.querySelector("#userLogin > div > .header > .close-btn");
    ...
    fetchResult.then(res=>res.json()).then((response)=>{
        if (response.email === undefined || response.phone === undefined ){
          ...
          document.getElementsByName("email")[0].value= requestJson.email;
            ...
            document.querySelectorAll(".clubbed-items .navbar-nav .dropdown-menu li")[0].remove();
            document.querySelectorAll(".clubbed-items .navbar-nav .dropdown-menu li")[1].remove();
            document.querySelector(".clubbed-items .navbar-nav .dropdown-menu hr").remove();
