...
function invokeRegister(){
    document.getElementById("registerForm").dispatchEvent(new CustomEvent('submit',{cancelable:false}));
...
//Todo : Change the route for host login and register and make the enhancement
...
if (document.getElementById("you-earn") != null) {
    document.getElementById("you-earn").addEventListener("click", () => {
        ...
        document.getElementById("loginSignupForm").addEventListener('submit', (e) => {
            ...
            //Handle host login/signup
            fetch('http://localhost:3000/host/authenticate', {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
                ...
                if (response.email == requestJson.email || response.phone == requestJson.phoneNumber) {
                ...
                <li><button class="dropdown-item" type="button">Help</button></li>`
                    ...
                    document.querySelector("#userLogin .container #registerForm").addEventListener('submit', (e) => {
                        ...
                        //POST call from form input
                        let fetchResult = fetch("http://localhost:3000/host/register", {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json"
                            },
                        ...
                        fetchResult.then(res => res).then((response) => {
                            if (!response.ok){
                                response.json().then((val)=>{
                                    console.log(val);
                                    document.getElementById("liveAlertPlaceholder").appendChild(
                ...
                <li><button class="dropdown-item" type="button">Help</button></li>`
                    ...
                    //Close button action for registration form
                    document.querySelector("#userLogin > div.mb-2 > div > button").addEventListener('click', () => {
